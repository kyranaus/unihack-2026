...
const services = {
  ["ssr"]: lazyService(() => import("./_ssr/server-BubZoQFo.mjs").then(function(n) {
    return n.i;
  }))
};
...
const _lazy_qGsDwY = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_qGsDwY };
  return ((_m, p) => {
