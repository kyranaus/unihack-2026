import { c as createKyselyAdapter, k as kyselyAdapter, g as getKyselyDatabaseType } from "../_libs/better-auth__kysely-adapter.mjs";
import { c as createMemoryHistory } from "../_libs/tanstack__history.mjs";
import { o as defineHandlerCallback, a as rootRouteId, p as getNormalizedURL, q as getOrigin, u as attachRouterServerSsrUtils, v as createSerializationAdapter, w as createRawStreamRPCPlugin, i as isNotFound, b as isRedirect, x as isResolvedRedirect, y as mergeHeaders, z as executeRewriteInput, A as defaultSerovalPlugins, C as makeSerovalPlugin, c as transformPipeableStreamWithRouter, t as transformReadableStreamWithRouter } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CX9NjgVk.mjs");
...
async function loadEntries() {
  const routerEntry = await import("./router-DL5qrXNE.mjs").then((n) => n.a);
...
const indexC6hDhOht = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  createKyselyAdapter,
