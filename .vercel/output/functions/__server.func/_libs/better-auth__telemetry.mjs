...
import { g as getBooleanEnvVar, E as ENV, i as isTest, l as logger, e as env, b as getEnvVar } from "./better-auth__core.mjs";
import { b as betterFetch } from "./better-fetch__fetch.mjs";
import { d as createHash, a as base64, c as createRandomStringGenerator } from "./better-auth__utils.mjs";
...
async function readRootPackageJson() {
  ...
  try {
    ...
    const raw = await fsPromises.readFile(path__default.join(cwd, "package.json"), "utf-8");
...
async function getPackageVersion(pkg) {
  ...
  try {
    ...
    const pkgJsonPath = path__default.join(cwd, "node_modules", pkg, "package.json");
