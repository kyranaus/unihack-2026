import { i as isORPCErrorStatus, f as fallbackORPCErrorStatus, O as ORPCError } from "./orpc__client.mjs";
...
const EVENT_ITERATOR_DETAILS_SYMBOL = /* @__PURE__ */ Symbol("ORPC_EVENT_ITERATOR_DETAILS");
...
export {
  ...
  getEventIteratorSchemaDetails as g,
