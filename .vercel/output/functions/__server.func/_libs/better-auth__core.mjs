import { o as object, d as date, s as string, a as string$1, n as number, b as boolean, i as ipv4, c as ipv6, _ as _enum } from "./zod.mjs";
import { A as APIError$1, c as createMiddleware, a as createEndpoint } from "./better-call.mjs";
import { c as createRandomStringGenerator, b as base64Url, a as base64 } from "./better-auth__utils.mjs";
import { b as betterFetch } from "./better-fetch__fetch.mjs";
import { d as decodeJwt, a as decodeProtectedHeader, j as jwtVerify, i as importJWK, c as createRemoteJWKSet } from "./jose.mjs";
...
const import__better_auth_core_db = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  accountSchema,
  coreSchema,
  getAuthTables,
...
export {
  ...
  isDevelopment as D,
  ENV as E,
  createRateLimitKey as F,
  getCurrentAdapter as G,
  getCurrentAuthContext as H,
  generateId as I,
  runWithTransaction as J,
  filterOutputFields as K,
  queueAfterTransactionHook as L,
  import__better_auth_core_db as M,
  defineRequestState as N,
  SocialProviderListEnum as S,
  capitalizeFirstLetter as a,
  getEnvVar as b,
  createAdapterFactory as c,
  createAuthMiddleware as d,
  env as e,
  BASE_ERROR_CODES as f,
  getBooleanEnvVar as g,
  isProduction as h,
  isTest as i,
  createAuthEndpoint as j,
  deprecate as k,
  logger as l,
  hasRequestState as m,
  normalizePathname as n,
  runWithRequestState as o,
  runWithEndpointContext as p,
  safeJSONParse as q,
  runWithAdapter as r,
  shouldPublishLog as s,
  createLogger as t,
  getAuthTables as u,
  socialProviders as v,
  getBetterAuthVersion as w,
  initGetModelName as x,
  initGetFieldName as y,
  isValidIP as z
};
