...
export default function RecordView() {
  ...
  // Collision detection with session logging
  ...
  // Start/stop both recorders + AI session
  useEffect(() => {
    if (isRecording) {
      startRec();
  ...
  }, [isRecording, startRec, stopRec, backRecorder.startRecording, backRecorder.stopRecording, addLog]);
