...
function RecordPage() {
  return (
    <main className="fixed inset-0 z-50 flex flex-col bg-background text-foreground">
      {/* Back button */}
      <div className="absolute left-3 top-4 z-10">
        <Link
          to="/"
          className="flex h-9 w-9 items-center justify-center rounded-full bg-black/50 text-white backdrop-blur-sm no-underline"
        >
